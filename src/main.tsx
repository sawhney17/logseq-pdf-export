...
//   if logseq.settings.
// }
const propertyOptions = ["Hide Page Properties", "Hide Brackets", "Hide Bullets"]
...
console.log(logseq.settings[`${templateName}Options`].includes("Hide Bullets"))
...
console.log(finalString)
    ...
    logseq.App.getCurrentGraph().then(async (graph) => {
      ...
      const final4String = final3String.replaceAll("../assets", `${graph.path}/assets`).replaceAll("<strong>", "</span><strong>").replaceAll("<em>", "</span><em>").replaceAll("<code>", "</span><code>").replaceAll("<p>", "<p><span>").replaceAll("</p>", "</span></p>")
      handleClosePopup()
